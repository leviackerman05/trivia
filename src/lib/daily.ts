...
export const dailyGames: DailyGame[] = [
  ...
  },
  {
    ...
    emoji: 'popcorn',
    category: 'movies',
    description: 'Ten synopses, some real and some invented. Spot the made-up plots.',
    estimatedMinutes: 5,
    tiers: [],
    live: true,
  },
  {
    ...
    emoji: 'music-note',
    category: 'music',
    description: 'Name that song from emoji, year, and BPM clues in ten rounds, no audio needed.',
    estimatedMinutes: 5,
    tiers: [],
    live: true,
  },
  // [R20] Daily Wordle: the same five-letter word for everyone per UTC day.
  // (R19 Daily Chess was reverted same-day by D067 — chess becomes a
  // client-side CPU game, not a daily; the FEN validator stays dormant.)
  {
    slug: 'wordle',
    name: 'Daily Wordle',
    emoji: 'text',
    category: 'word',
    description: 'The same five-letter word for everyone today. Six guesses, letter by letter.',
    estimatedMinutes: 5,
    tiers: [],
    live: true,
  },
