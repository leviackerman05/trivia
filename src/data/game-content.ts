...
export const gameContent: Record<string, GameSeoContent> = {
    ...
    faqs: [
      {
        ...
        answer:
          'Yes, every Trivia & Games game is free. No downloads, no accounts, no paywalls. Create a room and share the link.',
      },
      {
  ...
  'emoji-plot': {
    ...
    sections: [
      ...
      {
        heading: 'Playing solo, and sharing',
        body: 'Emoji Plot is built for solo play and for sharing. Every finished game lands on the daily leaderboard with a shareable score image, and the create-your-own mode generates a challenge link you can drop into any group chat, friends open it and try to beat your puzzle. The ten-question format takes about five minutes, and the progressive hints make every round winnable even when you are not a movie buff. The fuzzy answer matching means typos rarely cost you, which keeps the game friendly for casual players. The mix of movies and books also means there is something for every kind of pop-culture fan, the book rounds are sneaky favorites. Grab a friend, beat their score, and let the leaderboard turn friendly competition into a daily habit.',
      },
    ],
    faqs: [
      {
  ...
  'genre-swap': {
    metaDescription:
      'Play Genre Swap online free, famous movie plots rewritten in wildly wrong genres. Spot the original film from four options before the round timer runs out.',
    sections: [
      {
  ...
  charades: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Charades is the original party game, and the Trivia & Games version is built for a single shared screen or pass-the-phone play, perfect for family gatherings, game nights, and classroom drama warm-ups. The Hollywood/Bollywood toggle makes it a hit across cultures.',
      },
      {
        heading: 'Devices & requirements',
  ...
  trivia: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Trivia is the most flexible game on Trivia & Games: a solo daily ritual, a classroom review tool, a competitive room race, or a comedy mode for game nights. With 525 questions across ten categories, including Geography, Movies, Music, Food, and Technology, it is the definitive free online trivia game for groups and solo players alike, and it stays fresh all year round.',
      },
      {
        heading: 'Devices & requirements',
  ...
  sudoku: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'The daily sudoku joins the daily trivia as one of Trivia & Games’s rotating daily games. Play both each day to keep your streak alive, compare your finish times on the leaderboard, and share your completed-grid score card with friends. Same puzzle, same day, same rules for everyone, that is what makes the daily games addictive.',
      },
    ],
    faqs: [
      {
